    ...
    {dialogConfirmationData.visable && (
                    <DialogConfirmation
                        productId={dialogConfirmationData.id} // Corrigido: Passando productId
                        orderId={null} // Corrigido: Passando orderId (pode ser null)
                        message={dialogConfirmationData.message}
                        onDialogAnswer={(answer: boolean, orderId: number | null, productId: number | null) => handleDialogConfirmationAnswer(answer, productId)}
